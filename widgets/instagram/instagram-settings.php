...
class Wpzoom_Instagram_Widget_Settings {
    ...
    function add_action_links( $links, $file ) {
        ...
        $settings_link = sprintf(
            ...
            esc_html__( 'Settings', 'appland-core' )
        );
    ...
    public function settings_page() {
        ...
        ?>
            ...
            <div class="wrap">
                ...
                <h1><?php _e( 'Instagram Widget by Financo', 'appland-core' ); ?></h1>
                ...
                <div class="zoom-instagram-widget">
                    ...
                    <p class="description"><?php _e( 'Due to recent Instagram API changes it is no longer possible to display photos from a different Instagram account then yours. The widget will automatically display the latest photos of the account which was authorized on this page.', 'appland-core' ); ?></p>
                    ...
                    <a class="button button-connect" href="<?php echo esc_url( $oauth_url ); ?>">
                        <?php if ( ! Wpzoom_Instagram_Widget_API::getInstance()->is_configured() ) : ?>
                            <span><?php _e( 'Connect with Instagram', 'appland-core' ); ?></span>
                        <?php else: ?>
                            <span class="zoom-instagarm-widget-connected"><?php _e( 'Re-connect with Instagram', 'appland-core' ); ?></span>
                        <?php endif; ?>
                    </a>
    ...
    public function scripts( $hook ) {
        ...
        wp_localize_script( 'zoom-instagram-widget-admin', 'zoom_instagram_widget_admin', array(
            'i18n_connect_confirm' => __( "Instagram Widget is already connected to Instagram. Do you want to connect again?", 'appland-core' ),
        ) );
    }
    ...
    public function sanitize( $input ) {
        ...
        if ( $validation_result !== true ) {
            $access_token_error_message = __( 'Provided access token is has been rejected by Instagram Api. Please check your input data.', 'appland-core' );
