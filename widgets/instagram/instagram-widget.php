...
// require_once( plugin_dir_path( __FILE__ ) . 'instagram-settings.php' );
// require_once( plugin_dir_path( __FILE__ ) . 'class-instagram-widget.php' );

add_action( 'widgets_init', 'zoom_instagram_widget_register' );
function zoom_instagram_widget_register() {
	register_widget( 'Apland_Instagram_Widget' );
}
